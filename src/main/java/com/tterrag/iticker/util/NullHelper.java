...
import com.tterrag.iticker.util.annotation.Nullable;
...
public final class NullHelper {
    ...
    public final static <P> P notnull(@Nullable P o, String message) {
        if (o == null) {
            throw new NullPointerException("Houston we have a problem: '" + message + "'. " + "Please report this to the Main bugtracker unless you are using some old version. Thank you.");
        }
        return o;
    }
    ...
    public final static <P> P first(@Nullable P... o) {
        ...
        throw new NullPointerException("Houston we have a problem. Please report that to the Main bugtracker unless you are using some old version. Thank you.");
    }
}
